...
import 'package:kikoenai_core/core/model/user/login_params.dart';
import 'package:kikoenai_core/core/model/user/register_model.dart';
...
class AuthNotifier extends AsyncNotifier<AuthState> {
  ...
  /// 登录逻辑：不再手动处�?Loading，遇到错误直�?throw 即可
