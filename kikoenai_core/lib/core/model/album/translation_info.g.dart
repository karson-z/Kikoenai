...
TranslationInfo _$TranslationInfoFromJson(
  ...
  translationStatusForTranslator:
      (json['translation_status_for_translator'] as Map<String, dynamic>?)?.map(
        (k, e) =>
            MapEntry(k, TranslationStatus.fromJson(e as Map<String, dynamic>)),
      ),
);

Map<String, dynamic> _$TranslationInfoToJson(
  TranslationInfo instance,
) => <String, dynamic>{
  'lang': instance.lang,
  ...
  'translation_status_for_translator': instance.translationStatusForTranslator,
};
