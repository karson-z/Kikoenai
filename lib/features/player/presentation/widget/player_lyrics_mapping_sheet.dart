...
class SubtitleMappingSheet extends StatefulWidget {
  ...
  static Future<Map<String, FileNode?>?> show(
    ...
    return KikoenaiDialog.showBottomSheet<Map<String, FileNode?>>(
      ...
      builder: (context) => SubtitleMappingSheet(
        playlist: playlist,
  ...
  @override
  State<SubtitleMappingSheet> createState() => _SubtitleMappingSheetState();
}

class _SubtitleMappingSheetState extends State<SubtitleMappingSheet> {
        ...
        child: availableSubtitles.isEmpty
          ...
          itemBuilder: (context, index) {
            ...
            return ListTile(
              ...
              title: Text(node.title ?? '未知文件名', maxLines: 1, overflow: TextOverflow.ellipsis),
              onTap: () {
