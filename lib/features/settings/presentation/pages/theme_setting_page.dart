...
class _ThemeSettingPageState extends ConsumerState<ThemeSettingPage> {
              ...
              Padding(
                ...
                child: Wrap(
                  ...
                  children: [
                    // 遍历预设颜色
                    ..._colors.map((c) {
                      final isSelectedColor = theme.seedColor.value == c.value;
                      return _ColorSwatch(
                        color: c,
                    ...
                    // 自定义颜色按钮 (取色器)
                    _CustomColorButton(
                      currentColor: theme.seedColor,
                      onTap: () => _showColorPicker(context, theme.seedColor, themeState),
                    ),
                  ],
                ),
              ),
  ...
  /// 弹出自定义颜色选择器
  Future<void> _showColorPicker(BuildContext context, Color currentColor, dynamic themeState) async {
