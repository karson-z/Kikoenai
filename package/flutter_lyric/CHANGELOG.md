...
- Add the Apple Music inspired style preset and visual treatment.
- Add spring scrolling, inactive-line depth blur, and active progress glow.
- Keep upstream controller, parser, selection, and translation APIs compatible.
