...
mixin LyricScrollMixin<T extends StatefulWidget>
  ...
  void updateScrollY({bool animate = true}) {
    ...
    if (currentLayout != null) {
      ...
      final ScrollBehaviorConfig? scrollBehavior = style.scrollBehavior;
      if (scrollBehavior != null) {
        _translationAnimation = scrollBehavior.applyAnimation(
          controller: _scrollController,
          begin: scrollY,
          end: target,
        );
        if (_translationAnimation is AlwaysStoppedAnimation<double>) {
          scrollY = target;
        }
        return;
      }
