...
class LyricStyle {
  ...
  /// 非活动行的高斯模糊半径，用于营造景深。
  final double inactiveLineBlurRadius;

  /// 活动歌词进度高亮周围的柔光半径。
  final double activeLineGlowRadius;

  /// 活动歌词柔光透明度，取值范围为 0 到 1。
  final double activeLineGlowOpacity;
  ...
  LyricStyle({
    ...
    this.inactiveLineBlurRadius = 0,
    this.activeLineGlowRadius = 0,
    this.activeLineGlowOpacity = 0,
    this.highlightTransitionDuration = const Duration(milliseconds: 200),
    ...
    this.activeLineOnly = false,
        ...
        assert(inactiveLineBlurRadius >= 0),
        assert(activeLineGlowRadius >= 0),
        assert(activeLineGlowOpacity >= 0 && activeLineGlowOpacity <= 1),
        assert(
          selectionAutoResumeDuration < activeAutoResumeDuration,
  ...
  LyricStyle copyWith({
    ...
    double? inactiveLineBlurRadius,
    double? activeLineGlowRadius,
    double? activeLineGlowOpacity,
    Duration? highlightTransitionDuration,
    ...
    return LyricStyle(
      ...
      scrollBehavior: scrollBehavior == _unset
          ? this.scrollBehavior
      ...
      inactiveLineBlurRadius:
          inactiveLineBlurRadius ?? this.inactiveLineBlurRadius,
      activeLineGlowRadius: activeLineGlowRadius ?? this.activeLineGlowRadius,
      activeLineGlowOpacity:
          activeLineGlowOpacity ?? this.activeLineGlowOpacity,
      highlightTransitionDuration:
          highlightTransitionDuration ?? this.highlightTransitionDuration,
  ...
  RenderComparison compareTo(LyricStyle other) {
    ...
    if (inactiveLineBlurRadius != other.inactiveLineBlurRadius ||
        activeLineGlowRadius != other.activeLineGlowRadius ||
        activeLineGlowOpacity != other.activeLineGlowOpacity ||
        activeHighlightColor != other.activeHighlightColor ||
        activeHighlightGradient != other.activeHighlightGradient ||
        activeHighlightExtraFadeWidth != other.activeHighlightExtraFadeWidth) {
